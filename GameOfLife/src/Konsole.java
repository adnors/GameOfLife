...
public class Konsole extends Ausgabe {
	...
	/**
	 * Zeichenarray, das zur Ausgabe des Spielfelds √ºber die Konsole verwendet werden
	 * ' ': Keine Zelle
	 * '.': Zelle mit Alter = 1
	 * '+': Zelle mit Alter = 2
	 * '*': Zelle mit Alter = 3
	...
	/**
	 * Gibt das aktuell berechnete Spielfeld zur√ºck
			...
			for (int j = 0; j < feld.anzahlSpalten(); j++) {	//Geht einzelne Elemente in der Reihe durch
				if (feld.zelleLebt(i, j)) {						//Wenn Zelle lebt, gebe entsprechendes Zeichen, abh‰ngig vom Alter der Zelle, aus dem Zeichenarray aus
					...
					case 4:
						...
						break;
					default:
						System.out.print(Zeichenarray[4]);		//Alter grˆﬂer als 4
						break;
					}
				}
